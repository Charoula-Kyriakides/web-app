...
class GumtreeScraper:
    ...
    def parse_page(self):
        ...
        """
        # url = f"https://www.gumtree.com/search?search_location={self.user_location}&q={self.keywords}&page={self.page_n}&sort=price_lowest_first&search_distance={self.distance}&max_price=0"
